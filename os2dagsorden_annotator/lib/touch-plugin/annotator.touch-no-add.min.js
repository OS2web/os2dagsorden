...
((function () {
    ...
    Annotator.Plugin.Touch = a = function (a) {
        ...
        return d(f, a), e = Annotator._t, c = Annotator.$, f.states = {
            ...
            return this.isAnnotating() && this.range && this._isValidSelection(this.range)
	    //remove adding annotation functionality on touch devices
	    //? (this.adder.removeAttr("disabled"), this.showControls()) : 
            //(this.adder.attr("disabled", ""), this.hideControls())
