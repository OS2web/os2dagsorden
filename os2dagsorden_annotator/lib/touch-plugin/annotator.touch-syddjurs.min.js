...
((function () {
    ...
    Annotator.Plugin.Touch = a = function (a) {
        ...
        }, f.prototype.showControls = function (control_class) {
	    if (control_class)
	      return jQuery("."+control_class).removeClass(this.classes.hide), this
	    else
	  ...
	  var element_id = this.element.parent().attr("id");
            this.annotator.adder.remove(), this.controls = c(this.template).appendTo("body"), jQuery(".annotator-touch-widget:last").addClass("controls_" + element_id), this.adder = this.controls.find(".annotator-add"), this.adder.bind("tap", {
            ...
            if (b.rangeCount === 0 || this.range && this.range.collapsed) this.range = null, this.selectionString = "";
	  ...
	  console.log('on selection');
		...
		if (sel.rangeCount) {
			...
			parentEl = jQuery(parentEl).parents(".attachment_text_container");
			parentEl_id = parentEl.attr("id");
		    }
		}
	    }  
	    if (!parentEl_id)//default functionality
	    ...
	    else //id found, showing only one annotate button
	      return this.isAnnotating() && this.range && this._isValidSelection(this.range) ? (this.adder.removeAttr("disabled"), this.showControls("controls_" + parentEl_id)) : (this.adder.attr("disabled", ""), this.hideControls())
	    ...
	    var b, c, d;
		   ...
		   console.log(jQuery(a.currentTarget).size());
		   jQuery(a.currentTarget).parent().parent().toggleClass("annotator-touch-hide");
		   jQuery(a.currentTarget).attr("disabled", "");
		 }
            }
        ...
        function g(a, c) {
            var d = this;
            this.editor = a, 
  this._onOverlayTap = b(this._onOverlayTap, this), 
  this._onCancel = b(this._onCancel, this), 
  this._onSubmit = b(this._onSubmit, this), 
  this._onExpandTap = b(this._onExpandTap, this), 
  this._triggerAndroidRedraw = b(this._triggerAndroidRedraw, this), 
  g.__super__.constructor.call(this, this.editor.element[0], c), 
